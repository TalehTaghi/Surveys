    ...
    <PageComponent>
        <template v-slot:header>
            <div class="flex items-center justify-between">
                ...
                <button v-if="route.params.id" @click="deleteSurvey()" type="button" class="py-2 px-3 text-white bg-red-500 rounded-md hover:bg-red-700">
            ...
            <div class="shadow sm:rounded-md sm:overflow-hidden">
                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="title" id="title" v-model="model.title" autocomplete="survey_title"
                               class="mt-1 focus:ring-indigo-00 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="expire_date" id="expire_date" v-model="model.expire_date"
                               class="nt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                    </div>
                ...
                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                    <h3 class="text-2xl font-semibold flex items-center justify-between">
                        ...
                        <button type="button" @click="addQuestion(2)" class="flex items-center text-sm py-1 px-4 rounded-sm text-white bg-gray-600 hover:bg-gray-700">
...
function deleteSurvey() {
    if (confirm(`Are you sure you want to delete this survey? The operation can't be undone!`)) {
